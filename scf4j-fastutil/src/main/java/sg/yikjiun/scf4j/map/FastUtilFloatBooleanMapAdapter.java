 ...
 * @author Lee Yik Jiun
 */
public class FastUtilFloatBooleanMapAdapter implements FloatBooleanMap {
    private final Float2BooleanMap map;

    public FastUtilFloatBooleanMapAdapter(Float2BooleanMap map) {
        this.map = map;
    }
