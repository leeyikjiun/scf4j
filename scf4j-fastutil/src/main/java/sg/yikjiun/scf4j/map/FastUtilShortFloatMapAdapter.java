 ...
 * @author Lee Yik Jiun
 */
public class FastUtilShortFloatMapAdapter implements ShortFloatMap {
    private final Short2FloatMap map;

    public FastUtilShortFloatMapAdapter(Short2FloatMap map) {
        this.map = map;
    }
