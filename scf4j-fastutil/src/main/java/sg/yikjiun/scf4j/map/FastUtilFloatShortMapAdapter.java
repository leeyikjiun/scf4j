 ...
 * @author Lee Yik Jiun
 */
public class FastUtilFloatShortMapAdapter implements FloatShortMap {
    private final Float2ShortMap map;

    public FastUtilFloatShortMapAdapter(Float2ShortMap map) {
        this.map = map;
    }
